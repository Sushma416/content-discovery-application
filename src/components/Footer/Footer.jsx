            ...
            <div className="container">
                <div className="footer__content grid text__light text__center">
                    <div className="footer__content--item">
                        ...
                        <p className="para__text">&copy; 2022 Dev. Point. All rights reserved. Designed by Sushma.</p>
                    </div>

                    <div className="footer__content--item">
                        <a href = "mailto:someone@gmail.com">devpoint@gmail.com</a><br></br>
                        <span>9842357341</span>
                    </div>
