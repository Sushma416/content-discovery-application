            ...
            <div className="container flex">
                ...
                <div className="navbar__collapse">
                    <ul className="navbar__nav">
                        ...
                        <li className="nav__item">
                            <a href = "#skill" className = "nav__link text__upper fw_6 text__light">work</a>
                        </li>
                        <li className="nav__item">
                            <a href = "#process" className = "nav__link text__upper fw_6 text__light">process</a>
                        </li>
                        <li className="nav__item">
                            <a href = "#service" className = "nav__link text__upper fw_6 text__light">services</a>
                        </li>
                        <li className="nav__item">
                            <a href = "#contact" className = "nav__link text__upper fw_6 text__light">contact</a>
                        </li>
                        <li className="nav__item">
                            <a href = "#home" className = "nav__link text__upper fw_6 text__light">Signup/Login</a>
                        </li>
                    </ul>
                </div>
